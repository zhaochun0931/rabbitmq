...
def main():
    ...
    channel.queue_declare(queue='qq-1',durable=True, arguments={"x-queue-type": "quorum"})
    ...
    channel.basic_consume(queue='qq-1', on_message_callback=callback, auto_ack=True)
    # time.sleep(20)
