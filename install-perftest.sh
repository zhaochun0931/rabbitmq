...
wget https://github.com/rabbitmq/rabbitmq-perf-test/releases/download/v2.22.1/perf-test-2.22.1.jar
...
java -jar perf-test-2.22.1.jar --quorum-queue --queue qq
java -jar perf-test-2.22.1.jar --stream-queue --queue sq
...
java -jar perf-test-2.22.1.jar  -x 1 -y 2 -s 4096 -h amqp://admin:password@localhost:5672
